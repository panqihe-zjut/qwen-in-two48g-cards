...
class QwenImagePipeline(DiffusionPipeline, QwenImageLoraLoaderMixin):
    ...
    def __call__(
        ...
        if (self.transformer.device==prompt_embeds_mask.device)==False:
            prompt_embeds = prompt_embeds.to(self.transformer.device)
            prompt_embeds_mask = prompt_embeds_mask.to(self.transformer.device)
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                t = t.to(self.transformer.device)
